...
/*
 * Changed the package declaration in order to use the class. 
 * The package declaration won't stop showing errors.
 * 
 * This Class is intended to be used to print the ResultSet 
 * from the table to present to the user.
 * 
 * Class taken from Github repository of Hami Galip Torun.
 * Link : https://github.com/htorun/dbtableprinter
 * 
*/
